...
data:
  ...
  bundledCode: "#line 1 \"dp/DeterministicFiniteAutomatonDP.hpp\"\n\nenum class Ordering\
    ...
    class OrDfa {\n public:\n  using Alphabet = typename X::Alphabet;\n  using State\
    \ = pair<typename X::State, typename Y::State>;\n\n  OrDfa(const X& x, const Y&\
