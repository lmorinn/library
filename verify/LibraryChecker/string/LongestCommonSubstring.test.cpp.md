...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ 1, 0, -1};\n\n#pragma endregion\n#line 2 \"verify/LibraryChecker/string/LongestCommonSubstring.test.cpp\"\
    ...
    \  if (siz < 2) return {};\n  string concat = \"\";\n  for (int i = 0; i < siz;\
    \ i++) {\n    concat += v[i];\n    if (i + 1 != siz) concat += '$';\n  }\n  MonotonicMinQueue<int>\
    \ que;\n  vector<int> sa = suffixArray(concat);\n  vector<int> lcp = LCPArray(concat,\
...
layout: document
redirect_from:
- /verify/verify/LibraryChecker/string/LongestCommonSubstring.test.cpp
- /verify/verify/LibraryChecker/string/LongestCommonSubstring.test.cpp.html
