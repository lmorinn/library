...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ endregion\n#line 2 \"verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKind.test.cpp\"\
    ...
    \ 2 * M1M2M3, 3 * M1M2M3};\n        x -= offset[diff % 5];\n        c[i] = x;\n\
    \    }\n\n    return c;\n}\n\n}  // namespace atcoder\n\n\n#line 5 \"verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKind.test.cpp\"\
    ...
    \  for (int i = n; i >= 0; i--) {\n    f[i] = atcoder::modint998244353(i).pow(n)\
    \ * inv;\n    g[i] = (i % 2) ? -inv : inv;\n    inv *= i;\n  }\n  f *= g;\n  return\
    \ f;\n}\n#line 9 \"verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKind.test.cpp\"\
    \n\nint main() {\n  cin.tie(0)->sync_with_stdio(0);\n  int n;\n  in(n);\n  FPS\
    \ res = Stirling_number_2nd(n);\n  rep(i, n + 1) {\n    cout << res[i].val();\n\
    \    if (i != n) cout << \" \";\n  }\n  out();\n}\n"
  ...
  requiredBy: []
  timestamp: '2026-03-27 19:55:31+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKind.test.cpp
layout: document
redirect_from:
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKind.test.cpp
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKind.test.cpp.html
