...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ endregion\n#line 2 \"verify/LibraryChecker/math/enumerative-combinatorics/BellNumber.test.cpp\"\
    ...
    \ 2 * M1M2M3, 3 * M1M2M3};\n        x -= offset[diff % 5];\n        c[i] = x;\n\
    \    }\n\n    return c;\n}\n\n}  // namespace atcoder\n\n\n#line 5 \"verify/LibraryChecker/math/enumerative-combinatorics/BellNumber.test.cpp\"\
    ...
    \ = 1;\n  f.exp_inplace();\n  f[0]--;\n  f.exp_inplace();\n  for (int i = 0; i\
    \ < n + 1; i++) f[i] *= fac[i];\n  return f;\n}\n#line 9 \"verify/LibraryChecker/math/enumerative-combinatorics/BellNumber.test.cpp\"\
    \n\nint main() {\n  cin.tie(0)->sync_with_stdio(0);\n  int n;\n  in(n);\n  FPS<mint>\
    \ b = Bell_number<mint>(n);\n  rep(i, n + 1) {\n    cout << b[i].val();\n    if\
    \ (i != n) cout << \" \";\n  }\n  out();\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/LibraryChecker/math/enumerative-combinatorics/BellNumber.test.cpp
layout: document
redirect_from:
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/BellNumber.test.cpp
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/BellNumber.test.cpp.html
