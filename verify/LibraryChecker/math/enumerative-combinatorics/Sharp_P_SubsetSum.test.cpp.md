...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ endregion\n#line 2 \"verify/LibraryChecker/math/enumerative-combinatorics/Sharp_P_SubsetSum.test.cpp\"\
    ...
    \ 2 * M1M2M3, 3 * M1M2M3};\n        x -= offset[diff % 5];\n        c[i] = x;\n\
    \    }\n\n    return c;\n}\n\n}  // namespace atcoder\n\n\n#line 5 \"verify/LibraryChecker/math/enumerative-combinatorics/Sharp_P_SubsetSum.test.cpp\"\
    ...
    \  for (int i = 0; i < n; i++) {\n    assert(0 < s[i]);\n    if (s[i] <= t) freq[s[i]]++;\n\
    \  }\n  vector<S> iv(t + 1);\n  iv[1] = 1;\n  for (int i = 2; i < t + 1; i++)\
    \ iv[i] = iv[S::mod() % i] * (-(S::mod() / i));\n  for (long long k = 1; k < t\
    \ + 1; k++) {\n    if (freq[k] == 0) continue;\n    for (long long i = 1; k *\
    \ i < t + 1; i++) {\n      log_f[k * i] += (i % 2 ? 1 : -1) * iv[i] * freq[k];\n\
    \    }\n  }\n  return log_f.exp();\n}\n#line 9 \"verify/LibraryChecker/math/enumerative-combinatorics/Sharp_P_SubsetSum.test.cpp\"\
    \n\nint main() {\n  cin.tie(0)->sync_with_stdio(0);\n  int n, t;\n  in(n, t);\n\
    \  vector<long long> s(n);\n  in(s);\n  FPS<mint> res = sharp_p_subset_sum<mint>(s,\
    \ t);\n  rep(i, 1, t + 1) {\n    cout << res[i].val();\n    if (i != t) cout <<\
    \ \" \";\n  }\n  out();\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/LibraryChecker/math/enumerative-combinatorics/Sharp_P_SubsetSum.test.cpp
layout: document
redirect_from:
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/Sharp_P_SubsetSum.test.cpp
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/Sharp_P_SubsetSum.test.cpp.html
