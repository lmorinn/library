...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ endregion\n#line 2 \"verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.test.cpp\"\
    ...
    \ 2 * M1M2M3, 3 * M1M2M3};\n        x -= offset[diff % 5];\n        c[i] = x;\n\
    \    }\n\n    return c;\n}\n\n}  // namespace atcoder\n\n\n#line 5 \"verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.test.cpp\"\
    ...
    #line 2 \"math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.hpp\"\
    \n\ntemplate <class S>\nFPS<S> Stirling_number_2nd_fixed_k(int n, int k) {\n \
    \ FPS<S> f(n + 1);\n  f[1] = 1;\n  f.exp_inplace();\n  f[0]--;\n  f.pow_inplace(k);\n\
    \  S k_;\n  S fac = 1;\n  for (int i = 0; i < n + 1; i++) {\n    if (i == k) k_\
    \ = fac.inv();\n    f[i] *= fac;\n    fac *= (i + 1);\n  }\n  for (int i = 0;\
    \ i < n + 1; i++) f[i] *= k_;\n  return f;\n}\n#line 9 \"verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.test.cpp
layout: document
redirect_from:
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.test.cpp
- /verify/verify/LibraryChecker/math/enumerative-combinatorics/StirlingNumberoftheSecondKindFixedK.test.cpp.html
