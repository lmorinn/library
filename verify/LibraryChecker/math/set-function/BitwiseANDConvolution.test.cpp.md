...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ endregion\n#line 2 \"verify/LibraryChecker/math/set-function/BitwiseANDConvolution.test.cpp\"\
    ...
    \n\ntemplate <class T>\nvector<T> and_convolution(int n, vector<T> a, vector<T>\
    \ b) {\n  vector<T> za = superset_zeta(n, a);\n  vector<T> zb = superset_zeta(n,\
    \ b);\n  vector<T> d(1 << n);\n  for (int i = 0; i < (1 << n); i++) d[i] = za[i]\
    \ * zb[i];\n  return superset_mobius(n, d);\n}\n#line 5 \"verify/LibraryChecker/math/set-function/BitwiseANDConvolution.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/LibraryChecker/math/set-function/BitwiseANDConvolution.test.cpp
layout: document
redirect_from:
- /verify/verify/LibraryChecker/math/set-function/BitwiseANDConvolution.test.cpp
- /verify/verify/LibraryChecker/math/set-function/BitwiseANDConvolution.test.cpp.html
