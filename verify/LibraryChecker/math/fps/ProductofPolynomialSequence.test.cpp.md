...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ endregion\n#line 2 \"verify/LibraryChecker/math/fps/ProductofPolynomialSequence.test.cpp\"\
    ...
    \ 2 * M1M2M3, 3 * M1M2M3};\n        x -= offset[diff % 5];\n        c[i] = x;\n\
    \    }\n\n    return c;\n}\n\n}  // namespace atcoder\n\n\n#line 3 \"math/fps/ProductofPolynomialSequence.hpp\"\
    \n\ntemplate <class S>\nvector<S> product_of_polynomial_sequence(const vector<vector<S>>&\
    \ poly) {\n  int n = int(poly.size());\n  auto compare = [](const vector<S>& a,\
    ...
    \  return q.top();\n}\n#line 4 \"verify/LibraryChecker/math/fps/ProductofPolynomialSequence.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2026-03-26 13:15:11+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/LibraryChecker/math/fps/ProductofPolynomialSequence.test.cpp
layout: document
redirect_from:
- /verify/verify/LibraryChecker/math/fps/ProductofPolynomialSequence.test.cpp
- /verify/verify/LibraryChecker/math/fps/ProductofPolynomialSequence.test.cpp.html
