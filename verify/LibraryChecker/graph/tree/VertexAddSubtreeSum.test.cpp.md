...
data:
  ...
  bundledCode: "#line 2 \"template/template.hpp\"\n#pragma region Macros\n#include\
    ...
    \ int n, root, edge;\n  vector<vector<int>> g;\n  vector<int> heavy_p, heavy_l,\
    \ light_p, idx, xdi, sub_siz;\n\n  int dfs(int cur, int prev) {\n    int sub =\
    \ 1;\n    for (int& nex : g[cur]) {\n      if (nex == prev) {\n        swap(g[cur].back(),\
    \ nex);\n        g[cur].pop_back();\n        break;\n      }\n    }\n    int best\
...
layout: document
redirect_from:
- /verify/verify/LibraryChecker/graph/tree/VertexAddSubtreeSum.test.cpp
- /verify/verify/LibraryChecker/graph/tree/VertexAddSubtreeSum.test.cpp.html
