...
data:
  ...
  bundledCode: "#line 1 \"data-structure/wavelet-matrix/WaveletMatrixTemplateSum.hpp\"\
    ...
    \            }\n        }\n    }\n\n    inline void srsum_set(const vector<T>\
    \ &v) {\n        for (int i = 0; i < n; i++) {\n            srsum[i + 1] = srsum[i]\
    ...
    \     r = rank0_r;\n            }\n        }\n        return less;\n    }\n\n\
    \    // v[l,r) \u306E\u4E2D\u3067\u5024\u304Ck\u672A\u6E80\u306E\u500B\u6570\u3068\
    \u7DCF\u548C\u3092\u8FD4\u3059\n    pair<long long, long long> rank_less_sum(unsigned\
    \ l, unsigned r, T k) {\n        long long less = 0;\n        long long less_sum\
    ...
    \ |= (1ULL << (bitsize - i - 1));\n                res += b[i].rank_srsum(rank0_r)\
    \ - b[i].rank_srsum(rank0_l);\n                l = zero[i] + rank1_l;\n      \
    \          r = zero[i] + rank1_r;\n                k -= num0;\n            } else\
    \ {\n                l = rank0_l;\n                r = rank0_r;\n            }\n\
    \        }\n        res += int64_t(cmp[val]) * (k);\n        return res;\n   \
    \ }\n\n    // v[l,r]\u3092\u964D\u9806\u30BD\u30FC\u30C8\u3057\u305F\u6642\u306E\
    \u5148\u982Dk\u500B\u306E\u7DCF\u548C\u3092\u8FD4\u3059\n    long long kth_descending_sum(unsigned\
    \ l, unsigned r, unsigned k) {\n        return range_sum(l, r) - kth_ascending_sum(l,\
  ...
  code: "\ntemplate <class T>\nclass BitVector {\n   private:\n    unsigned n, cur,\
    ...
    \ rank_srsum(unsigned k) {\n        return srsum[k];\n    }\n\n    inline bool\
    \ access(unsigned k) {\n        return (rank(k + 1) - rank(k)) == 1;\n    }\n\
    };\n\ntemplate <class T>\nclass WaveletMatrix {\n   private:\n    unsigned n;\n\
    \    unsigned bitsize;\n    vector<BitVector<T>> b;\n    vector<unsigned> zero;\n\
    \    vector<int> stInd;\n    vector<unsigned> compressed;\n    vector<T> cmp;\n\
    \    vector<long long> sum;\n    T MI, MA;\n\n    // v[l,r) \u306E\u4E2D\u3067\
    \u5024\u304Ck\u672A\u6E80\u306E\u7DCF\u548C\u3092\u8FD4\u3059\n    long long rank_sum(unsigned\
    \ l, unsigned r, unsigned k) {\n        long long less_sum = 0;\n        for (unsigned\
